...
app.use(express.json()) // Para poder recibir JSON en los endpoints de API
...
// API endpoints
app.get('/api/agents/statistics', sessionManager.guard, homeController.getAgentStatistics)
app.get('/api/user/login-history', sessionManager.guard, homeController.getLoginHistory)
app.post('/api/calculate/price', homeController.calculatePrice)
...
app.use((err, req, res, next) => {
  ...
  // Usar getErrorMessage para obtener mensajes amigables
  res.locals.message = getErrorMessage(err)
